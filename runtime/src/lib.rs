...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("inherents-sample"),
	impl_name: create_runtime_str!("inherents-sample"),
	authoring_version: 3,
	spec_version: 3,
	impl_version: 0,
...
impl priceoracle::Trait for Runtime { }
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		Balances: balances,
		Sudo: sudo,
		PriceOracle: priceoracle::{Module, Call, Storage, Inherent},
	}
);
